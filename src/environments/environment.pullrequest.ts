...
export const environment = {
	production: true,
	apiBaseUrl: 'https://u77jy3fspi.execute-api.us-east-1.amazonaws.com/api',
	...
	groupInsights: 'https://sljnkh9aeg.execute-api.us-east-1.amazonaws.com/feature3',
	baseUrl: 'https://<PR_DOMAIN_URL>/app/',
	storageUrl: 'https://bd-convosight-dev-facebook-cmc-screenshot.s3.amazonaws.com/',
	envName: 'pullrequest',
	cookieDomain: '<PR_DOMAIN_URL>',
	envNameForLog: 'pullrequest',
	sentryIOUrl: 'https://36a19ad7a9ac4e09b78ac86f0b24d755@sentry.io/2292724',
	releaseVersion: '%VERSION%',
	fbreAskPermissionRedirectUrl: 'https://<PR_DOMAIN_URL>/app/group-admin/manage',
	...
	amplifyConfiguration: {
		...
		oauth: {
			...
			redirectSignIn: 'https://<PR_DOMAIN_URL>/app/login-response/',
			redirectSignOut: 'https://<PR_DOMAIN_URL>/logout/',
			responseType: 'code'
		},
		Storage: {
			AWSS3: {
	...
	landingPageUrl: 'https://<PR_DOMAIN_URL>/',
