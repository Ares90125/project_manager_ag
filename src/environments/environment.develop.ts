...
export const environment = {
	...
	baseUrl: 'https://develop.convosight.com/app/',
	storageUrl: 'https://bd-convosight-dev-facebook-cmc-screenshot.s3.amazonaws.com/',
	envName: 'develop',
	cookieDomain: 'develop.convosight.com',
	envNameForLog: 'Develop',
	sentryIOUrl: 'https://36a19ad7a9ac4e09b78ac86f0b24d755@sentry.io/2292724',
	releaseVersion: '%VERSION%',
	fbreAskPermissionRedirectUrl: 'https://develop.convosight.com/app/group-admin/manage',
	...
	amplifyConfiguration: {
		...
		oauth: {
			...
			redirectSignIn: 'https://develop.convosight.com/app/login-response/',
		...
		aws_appsync_graphqlEndpoint: 'https://iqbqjrqsrbdgrijmjdou34cm5i.appsync-api.us-east-1.amazonaws.com/graphql',
		aws_appsync_region: 'us-east-1',
		aws_appsync_authenticationType: 'AMAZON_COGNITO_USER_POOLS',
		API: {
			graphql_endpoint: 'https://graph.develop.convosight.com/graphql',
