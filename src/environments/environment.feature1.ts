...
export const environment = {
	groupInsights: 'https://sljnkh9aeg.execute-api.us-east-1.amazonaws.com/feature1',
	production: true,
	apiUrl: 'https://backend.convosight.com/feature1',
	...
	baseUrl: 'https://feature1.convosight.com/app/',
	storageUrl: 'https://bd-convosight-dev-facebook-cmc-screenshot.s3.amazonaws.com/',
	envName: 'feature1',
	cookieDomain: 'feature1.convosight.com',
	envNameForLog: 'Feature1',
	sentryIOUrl: 'https://36a19ad7a9ac4e09b78ac86f0b24d755@sentry.io/2292724',
	releaseVersion: '%VERSION%',
	fbreAskPermissionRedirectUrl: 'https://feature1.convosight.com/app/group-admin/manage',
	...
	amplifyConfiguration: {
		...
		oauth: {
			...
			redirectSignIn: 'https://feature1.convosight.com/app/login-response/',
			redirectSignOut: 'https://feature1.convosight.com/logout/',
			responseType: 'code'
		},
		Storage: {
			AWSS3: {
		...
		aws_appsync_graphqlEndpoint: 'https://u2loiekp2jebbhna3kazrmm2pe.appsync-api.us-east-1.amazonaws.com/graphql',
		aws_appsync_region: 'us-east-1',
		aws_appsync_authenticationType: 'AMAZON_COGNITO_USER_POOLS',
		API: {
			graphql_endpoint: 'https://graph.feature1.convosight.com/graphql',
			graphql_headers: async () => ({
				authorization: (await Auth.currentSession()).getIdToken().getJwtToken()
			})
		}
	},
	landingPageUrl: 'https://feature1.convosight.com/',
