...
export const environment = {
	groupInsights: 'https://backend.convosight.com/feature4/',
	production: true,
	apiUrl: 'https://backend.convosight.com/feature4',
	restApiUrl: 'https://rest-develop.convosight.com/api',
	...
	baseUrl: 'https://feature4.convosight.com/app/',
	storageUrl: 'https://bd-convosight-dev-facebook-cmc-screenshot.s3.amazonaws.com/',
	envName: 'feature4',
	cookieDomain: 'feature4.convosight.com',
	envNameForLog: 'Feature4',
	sentryIOUrl: 'https://36a19ad7a9ac4e09b78ac86f0b24d755@sentry.io/2292724',
	releaseVersion: '%VERSION%',
	fbreAskPermissionRedirectUrl: 'https://feature4.convosight.com/app/group-admin/manage',
	...
	amplifyConfiguration: {
		...
		oauth: {
			...
			redirectSignIn: 'https://feature4.convosight.com/app/login-response/',
			redirectSignOut: 'https://feature4.convosight.com/logout/',
			responseType: 'code'
		},
		Storage: {
			AWSS3: {
		...
		aws_appsync_graphqlEndpoint: 'https://xrbqbt5xqzbxxippry7yf2wrre.appsync-api.us-east-1.amazonaws.com/graphql',
		aws_appsync_region: 'us-east-1',
		aws_appsync_authenticationType: 'AMAZON_COGNITO_USER_POOLS',
		API: {
			graphql_endpoint: 'https://graph.feature4.convosight.com/graphql',
			graphql_headers: async () => ({
				authorization: (await Auth.currentSession()).getIdToken().getJwtToken()
			})
		}
	},
	second_graphql_endpoint: 'https://graph.feature4-2.convosight.com/graphql',
	landingPageUrl: 'https://feature4.convosight.com/',
