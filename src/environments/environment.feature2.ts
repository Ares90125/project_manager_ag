...
export const environment = {
	groupInsights: 'https://sljnkh9aeg.execute-api.us-east-1.amazonaws.com/feature2',
	production: true,
	apiUrl: 'https://backend.convosight.com/feature2',
	...
	baseUrl: 'https://feature2.convosight.com/app/',
	storageUrl: 'https://bd-convosight-dev-facebook-cmc-screenshot.s3.amazonaws.com/',
	envName: 'feature2',
	cookieDomain: 'feature2.convosight.com',
	envNameForLog: 'Feature2',
	sentryIOUrl: 'https://36a19ad7a9ac4e09b78ac86f0b24d755@sentry.io/2292724',
	releaseVersion: '%VERSION%',
	fbreAskPermissionRedirectUrl: 'https://feature2.convosight.com/app/group-admin/manage',
	...
	amplifyConfiguration: {
		...
		oauth: {
			...
			redirectSignIn: 'https://feature2.convosight.com/app/login-response/',
			redirectSignOut: 'https://feature2.convosight.com/logout/',
			responseType: 'code'
		},
		Storage: {
			AWSS3: {
		...
		aws_appsync_graphqlEndpoint: 'https://f5o4br73rvdrjd6cqjdvom2fva.appsync-api.us-east-1.amazonaws.com/graphql',
		aws_appsync_region: 'us-east-1',
		aws_appsync_authenticationType: 'AMAZON_COGNITO_USER_POOLS',
		API: {
			graphql_endpoint: 'https://graph.feature2.convosight.com/graphql',
			graphql_headers: async () => ({
				authorization: (await Auth.currentSession()).getIdToken().getJwtToken()
			})
		}
	},
	landingPageUrl: 'https://feature2.convosight.com/',
